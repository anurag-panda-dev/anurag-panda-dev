...
<table>
  <tr>
    <td width="50%" valign="top">
      <div align="center">
      <h3>🧠 LUMYN</h3>
      <p><b>AI-Powered Neuroscience Wearable Platform</b></p>
      </div>
      <p>An end-to-end neurotechnology system that captures real-time EEG brainwave data over BLE, applies filtering and feature extraction on the edge, and streams telemetry to an AI backend for cognitive state analysis.</p>
      <p>
        <img src="https://img.shields.io/badge/EEG-4A154B?style=flat-square&logo=signal&logoColor=white" />
    ...
    <td width="50%" valign="top">
      <div align="center">
      <h3>⚡ SlashForge</h3>
      <p><b>Developer Workspace & Workflow Tooling</b></p>
      </div>
      <p>A modular platform built for modern engineers to streamline scaffolding, benchmark system components, and automate developer workflows with extensible plugins and high performance.</p>
      <p>
...
<table>
  <tr>
    <td width="65%" valign="top">
      ...
      <p><i>An adaptive philosophical framework for human flourishing, cognitive evolution, and the boundary between mind and machine.</i></p>
      <p>
    ...
    <td width="35%" valign="top">
      <div align="center">
        ...
        <p>
          <img src="https://img.shields.io/badge/Status-Complete_Book-10B981?style=flat-square" alt="Status" />
          <img src="https://img.shields.io/badge/Domain-Cognitive_Philosophy-6366F1?style=flat-square" alt="Domain" />
        </p>
      </div>
    </td>
  </tr>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><i>Deconstructing human dynamics across physical and digital spaces through empirical observation, cognitive mapping, and behavioral forensics.</i></p>
      <ul>
    ...
    <td width="50%" valign="top">
      ...
      <p><i>Tracking human expression, identity vectors, and cyberbehavioral systems across virtual networks and decentralized platforms.</i></p>
      <ul>
...
<p>
  ...
  <img src="https://img.shields.io/badge/NativeWind-0EA5E9?style=for-the-badge&logo=tailwindcss&logoColor=white" alt="NativeWind" />
  <img src="https://img.shields.io/badge/Expo_CLI-4630EB?style=for-the-badge&logo=expo&logoColor=white" alt="Expo CLI" />
</p>
...
<picture>
  ...
  <img src="https://raw.githubusercontent.com/anurag-panda-dev/anurag-panda-dev/output/snake.svg" alt="Snake animation" width="100%" />
</picture>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <blockquote>
        <p><i>"One must still have chaos in oneself to give birth to a dancing star."</i></p>
        <p>— <b>Friedrich Nietzsche</b></p>
      </blockquote>
      <blockquote>
        <p><i>"Man is condemned to be free; because once thrown into the world, he is responsible for everything he does."</i></p>
        <p>— <b>Jean-Paul Sartre</b></p>
      </blockquote>
      <blockquote>
        <p><i>"The limits of my language mean the limits of my world."</i></p>
        <p>— <b>Ludwig Wittgenstein</b></p>
      </blockquote>
    </td>
    <td width="50%" valign="top">
      ...
      <blockquote>
        <p><i>"Focus is a matter of deciding what things you're not going to do."</i></p>
        <p>— <b>John Carmack</b></p>
      </blockquote>
      <blockquote>
        <p><i>"We can only see a short distance ahead, but we can see plenty there that needs to be done."</i></p>
        <p>— <b>Alan Turing</b></p>
      </blockquote>
    </td>
  </tr>
